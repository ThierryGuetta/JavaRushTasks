...
public class Solution {
    ...
    public static List<Horse> prepareHorsesAndStart(int horseCount) { //заполняется список лошадей и они стартуют
...
class Horse extends Thread {
    ...
    public void run() { // лошадь пробегает 1000 и финиширует
        String s = "";
