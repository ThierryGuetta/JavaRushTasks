...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        if (dateTime.getDayOfWeek() == DayOfWeek.SATURDAY) return true;
        else if (dateTime.getDayOfWeek() == DayOfWeek.FRIDAY && dateTime.getHour() >= 22) return true;
        else if (dateTime.getDayOfWeek() == DayOfWeek.SUNDAY && dateTime.getHour() < 23) return true;
        else return false;
    }
}
